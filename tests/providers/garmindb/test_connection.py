...
def fixture_for(settings: Settings, **kwargs: Any) -> Fixture:
...
class TestFirstBoot:
    ...
    def test_a_populated_corpus_reports_that_it_has_data(self, corpus_settings: Settings) -> None:
...
class TestPairedSessions:
    def test_both_databases_are_reachable_from_one_read(self, corpus_settings: Settings) -> None:
    ...
    def test_table_class_setup_ran_so_time_col_exists(self, corpus_settings: Settings) -> None:
...
class TestTimeZonePolicy:
    def test_the_policy_is_resolved_once_at_open(self, corpus_settings: Settings) -> None:
        fixture_for(corpus_settings)
        with GarminConnection(corpus_settings) as conn:
...
class TestSchemaMismatch:
    ...
    def test_a_schema_mismatch_is_a_kind_of_unavailable(self, corpus_settings: Settings) -> None:
    ...
    def test_a_repaired_corpus_clears_the_fault_on_reset(self, corpus_settings: Settings) -> None:
        fixture_for(corpus_settings)
        self._break_version(corpus_settings.db_dir / "garmin.db")
        with GarminConnection(corpus_settings) as conn:
            assert conn.fault is not None
...
class TestReset:
    def test_it_picks_up_a_rebuilt_database_file(self, corpus_settings: Settings) -> None:
...
class TestOperationalErrorRetry:
    ...
    def test_it_does_not_retry_forever(self, corpus_settings: Settings) -> None:
    ...
    def test_other_errors_are_not_retried_at_all(self, corpus_settings: Settings) -> None:
        attempts: list[int] = []
